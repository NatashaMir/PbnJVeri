 ...
 * 2012-04-28 Incremented number of tricks
 */
...
public class PbnGameTags {
    ...
    String[] maTagValues;
    int[] maUsedTags;
    private final PbnMoveNote[] maCallNote;
    private final PbnMoveNote[] maCardNote;
    private final PbnComment mGameComment;
    private final PbnComment[] maTagComments;
    private final PbnComment[] maCallNoteComments;
    private final PbnComment[] maCardNoteComments;
    private PbnMoveAnno[] maCallAnno;
    private final PbnMoveAnno[][] maaCardAnno;
    private final PbnTable mActionTable;
    private final PbnTable mAuctionTimeTable;
    private final PbnTable mInstantScoreTable;
    private final PbnTable mPlayTimeTable;
    private final PbnTable mScoreTable;
    private final PbnTable mTotalScoreTable;
    private final PbnTable mOptimumPlayTable;
    private final PbnTable mOptimumResultTable;
