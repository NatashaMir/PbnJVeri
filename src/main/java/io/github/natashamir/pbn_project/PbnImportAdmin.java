...
public class PbnImportAdmin {
    ...
    private final boolean[] mabUnknownSide;
    private final PbnHand mUnknownHand;
    private int mIllegalMove;
    private int mIllegalTrick;
    private final int[] maIllegalPlay;
    private final int[] maNrWon;
    private boolean mbLastCall;
    private int mLastCardTrick;
    private final PbnSide mLastCardSide;
