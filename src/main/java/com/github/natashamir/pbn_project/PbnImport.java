...
class PbnInputLine {
    private final PbnInputFile mInputFile;
...
class PbnInputBuffer {
    ...
    private final StringBuffer mInputBuffer;
    private int mPrevInputIndex;

    private final StringBuffer mErrorBuffer;
...
class PbnInputFile {
    ...
    private final PbnInputStream mInput;
...
public class PbnImport {
    ...
    private final String mStringEol;
...
*/
            ...
            if (c == PbnChar.LINEFEED) {
                ...
                } else if ((bTagFound) && (lNrNonSpace == 0)) {
                    bReady = true;
