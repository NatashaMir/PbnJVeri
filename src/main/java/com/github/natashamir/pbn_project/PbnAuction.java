...
public class PbnAuction {
    ...
    public PbnError Verify(
        ...
        if (NrPasses == PbnSide.NUMBER) {
            ...
            } else if (!lDeclarer.Is(PbnSide.EMPTY)) {
            ...
            if (lError.IsOK()) {
                ...
                } else if (!lTrump.Is(PbnTrump.NONE)) {
                    lError.Set(PbnError.BAD_TRUMP);
                }
            }
        } else if ((mNrCalls >= PbnSide.NUMBER)
         ...
         */
             ...
             */
                lError.Set(PbnError.BAD_TRUMP);
            } else if (lDeclarer.Is(PbnSide.IDLE)) {
            ...
            if (lError.IsOK()) {
                ...
                } else if (!oContract.GetTrump().equals(lCallTrump)) {
                    lError.Set(PbnError.BAD_TRUMP);
                } else if (!oContract.GetRisk().equals(lCallRisk)) {
                    lError.Set(PbnError.BAD_RISK);
                } else if (oContract.GetNrTricks() != lCallNrTricks) {
