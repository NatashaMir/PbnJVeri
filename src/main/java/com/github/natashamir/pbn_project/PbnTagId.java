...
public class PbnTagId {
    ...
    private static final int[] maMtsTags_10 =
            {
                    EVENT,
                    SITE,
                    DATE,
    ...
    private static final int[] maMtsTags_20 =
            {
                    EVENT,
                    SITE,
                    DATE,
    ...
    private static final int[] maTags_10 =
            {
                    ANNOTATOR,
                    ANNOTATORNA,
                    BIDSYSTEMEW,
    ...
    private static final int[] maTags_20 =
            {
                    APPLICATION,
                    DEALID,
                    PAIREW,
    ...
    private static final int[] maTags_21 =
            {
                    OPTIMUMSCORE
            };

    private static final int[] maTableTags_20 =
            {
                    ACTIONTABLE,
                    AUCTIONTIMETABLE,
                    INSTANTSCORETABLE,
    ...
    private static final int[] maTableTags_21 =
            {
                    OPTIMUMPLAYTABLE,
                    OPTIMUMRESULTTABLE
            };
    private static final Vector mvMtsTags10 = new Vector();
    private static final Vector mvMtsTags20 = new Vector();
    private static final Vector mvOptionalTags10 = new Vector();
    private static final Vector mvOptionalTags20 = new Vector();
    private static final Vector mvOptionalTags21 = new Vector();
    private static final Vector mvSupplementalTags10 = new Vector();
    private static final Vector mvSupplementalTags20 = new Vector();
    private static final Vector mvSupplementalTags21 = new Vector();
    ...
    private final String[] maTagNames =
            {
                    "Annotator",
                    "AnnotatorNA",
                    "Application",
